    ...
    <div class="login-box">
      ...
      <div class="logon" :class="{ hidden: !isLogin }">
        ...
        <el-form ref="loginFormRef1" :model="loginForm" label-width="50px" :rules="loginFormRule">
          ...
          <div class="btn-gourp">
            <div>
              <el-checkbox property="remember" class="remeber-password" v-model="checked"
      ...
      <div class="register" :class="{ hidden: isLogin }">
        ...
        <el-form ref="loginFormRef2" :model="addForm" label-width="50px" class="form-container" width="width"
          ...
          <el-form-item prop="real_name">
            <el-input v-model="addForm.real_name" placeholder="请输入姓名" show-word-limit clearable>
    ...
    if (valid) {
      ...
      if (res1.data.success !== false) {
        ...
        if (res2.data.success === false) {
          ...
          login1(addForm.username, addForm.password, loginForm.remember, (data) => {
...
const login = (formEl) => {
  ...
  formEl.validate(async (valid) => {
    if (valid) {
      ...
      login1(loginForm.username, loginForm.password, loginForm.remember, (data) => {
        const code = data.code;
        const res1 = data;
        if (code === '0') {
          const token = res1.data.token
