package com.nageoffer.shortlink.project.rabbitMq.consumer;
...
public class RabbitShortLinkStatsSaveConsumer {
    ...
    @RabbitListener(queues = "${spring.short-link.rabbit.queue}")
    public void onMessage(HashMap<String,String> message){
        try {
            ...
            if (StrUtil.isNotBlank(fullShortUrl)){
                ...
                ShortLinkStatsRecordDTO statsRecordDTO = JSON.parseObject(message.get("statsRecord"), ShortLinkStatsRecordDTO.class);
