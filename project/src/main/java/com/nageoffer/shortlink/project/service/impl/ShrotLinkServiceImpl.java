...
import com.nageoffer.shortlink.project.rabbitMq.producer.RabbitShortLinkStatsSaveProducer;
import com.nageoffer.shortlink.project.redisMq.producer.ShortLinkStatsSaveProducer;
...
public class ShrotLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private final RabbitShortLinkStatsSaveProducer rabbitShortLinkStatsSaveProducer;
    ...
    /**
     * 短链接信息统计，海量访问短链接，直接访问数据库，会导致数据库负载变高，甚至数据库宕机。为此，需要引入消息队列削峰。
     * @param fullShortUrl
     * @param gid
     * @param statsRecord
     */
